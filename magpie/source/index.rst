...
Magpie is heavily based on RISC-V and SPARC. It has 16-bit instructions, condition code branching, and a flat register file.

Originally, Magpie had load and branch delay slots. I ended up scrapping this because they made interrupts much harder to manage.
...
Currently, the Magpie emulator is finished. The assembler is almost finished.
